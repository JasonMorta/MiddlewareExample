...
** IMPORTANT: This middleware function are mainly used to perform tasks that are common to all routes,
** such as logging, authentication, etc. 
** We can also call it a 'preprocessor' function, because it runs before the controller.
** Middle ware can also be thought of as a **AKA: security check point***.
